    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack (alignment: .leading, spacing: 1) {
                ...
                Divider()
                InsuranceCardBottom(showEdit: $showEdit, provider: provider)
            }.padding(.leading,5)
            .padding(.trailing, 5)
        }
        .sheet(isPresented: $showEdit, content: {
            InsuranceDetails(insurance: provider).environmentObject(store)
        })
    }
}
    ...
    var body: some View {
            ...
            HStack {
                ...
                VStack (alignment: .leading, spacing: 3) {
                    ...
                    HStack {
                        Spacer()
                        Button(action: {self.showEdit.toggle()}, label: {
